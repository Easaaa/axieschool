          ...
          <header class='bg-white dark:bg-gray-800'>
            <nav class='bg-white dark:bg-gray-800'>
              <div class='container p-6 mx-auto'>
                <a
                  class='block text-center text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300'
                  href='#'>
                  AxieSchool
                </a>
                ...
                {/*   <div class='flex items-center justify-center mt-6 text-gray-600 capitalize dark:text-gray-300'>
                  <a
                    href='#'
                    class='text-gray-800 dark:text-gray-200 border-b-2 border-red-500 mx-1.5 sm:mx-6'>
                    home
                  </a>

                  <a
                    href='#'
                    class='border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-red-500 mx-1.5 sm:mx-6'>
                    features
                  </a>
            ...
            <div class='container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-128 lg:py-16 lg:flex-row lg:items-center lg:space-x-6'>
              <div class='flex flex-col items-center w-full lg:flex-row lg:w-1/2'>
                {/* <div class='flex justify-center order-2 mt-6 lg:mt-0 lg:space-y-3 lg:flex-col'>
                  <button class='w-3 h-3 mx-2 bg-red-500 rounded-full lg:mx-0 focus:outline-none'></button>
                  <button class='w-3 h-3 mx-2 bg-gray-300 rounded-full lg:mx-0 focus:outline-none hover:bg-red-500'></button>
                  <button class='w-3 h-3 mx-2 bg-gray-300 rounded-full lg:mx-0 focus:outline-none hover:bg-red-500'></button>
                  <button class='w-3 h-3 mx-2 bg-gray-300 rounded-full lg:mx-0 focus:outline-none hover:bg-red-500'></button>
                </div> */}
                ...
                <div class='max-w-lg lg:mx-12 lg:order-2'>
                  ...
                  {/*  <div class='mt-6'>
                    <a
                      href='#'
                      class='text-2xl block px-3 py-2 text-center text-white transition-colors duration-200 transform bg-red-500 rounded-md lg:inline hover:bg-red-400'>
                      Coming Soon
                    </a>
                  </div> */}
                </div>
