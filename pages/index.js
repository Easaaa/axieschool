      ...
      <Layout>
        ...
        <Container>
          <section class='text-gray-600 body-font'>
            <div class='mx-auto flex px-5 py-10 md:py-36 pb-60 md:-mt-20 items-center justify-center flex-col'>
              <img
                class='lg:w-2/6 md:w-3/6 w-5/6 object-cover object-center rounded'
                alt='hero'
                src='/logo.png'
              />
              <div class='text-center lg:w-2/3 w-full -mt-8 md:px-24'>
                ...
                <div class='grid md:grid-cols-2 place-items-center place-content-center gap-4 md:gap-6 max-w-sm mx-auto'>
                  <a
                    target='_blank'
                    href='https://discord.gg/4RCFsVMeMw'
                    class='flex place-content-center dark:text-gray-900 text-center w-80 md:w-40 dark:bg-white text-gray-800 bg-gray-300 border-0 py-2 px-6 focus:outline-none hover:bg-gray-100 rounded text-lg'>
                    Join Discord
                  </a>
                  <a
                    target='_blank'
                    ...
                    class='flex place-content-center text-white border-0 w-80 text-center py-2 px-6 md:w-40 focus:outline-none rounded text-lg'>
                    Fill the Form
                  </a>
                </div>
              </div>
